...
class BeaconScannerTest extends StatefulWidget {
  @override
  _BeaconScannerTestState createState() => _BeaconScannerTestState();
}

class _BeaconScannerTestState extends State<BeaconScannerTest> {
